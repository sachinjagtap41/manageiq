...
c2c_manageiq_plugin "manageiq-providers-ansible_tower", "dev" # can't move this down yet, because we can't autoload ManageIQ::Providers::AnsibleTower::Shared
...
gem "fog-telefonica",:git => "https://github.com/Click2Cloud/fog-telefonica.git", :branch => "master"
